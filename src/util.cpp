...
Graph* create_colab(Graph *g, int year_begin, int year_end) {
	vector<string> *authors = g->get_field_values_str("authors_idx");
	vector<string> *paper_idxs = g->get_field_values_str("id");
	return nullptr;
}